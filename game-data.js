  ...
  class Game {
    ...
    endFight(winner, method) {
      ...
      UI.resultCopy.textContent = draw
        ? `After ${this.scoreHistory.length} round(s), the judges could not separate the fighters.`
        : `${winner.name} wins ${by}. Final fight score: ${this.player.name} ${totalPlayer}, ${this.enemy.name} ${totalEnemy}.`;
